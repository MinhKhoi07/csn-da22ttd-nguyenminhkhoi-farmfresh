                    ...
                    <form action="{{ route('admin.promotions.update', $promotion->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="category" {{ old('type', $promotion->type) == 'category' ? 'selected' : '' }}>Theo danh mục</option>
                                <option value="product" {{ old('type', $promotion->type) == 'product' ? 'selected' : '' }}>Theo sản phẩm</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
