...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 05, 2026 lúc 02:41 AM
...
('laravel-cache-356a192b7913b04c54574d18c28d46e6395428ab', 'i:1;', 1767573897),
('laravel-cache-356a192b7913b04c54574d18c28d46e6395428ab:timer', 'i:1767573897;', 1767573897),
...
('laravel-cache-linh123@gmail.com|127.0.0.1', 'i:1;', 1767534818),
('laravel-cache-linh123@gmail.com|127.0.0.1:timer', 'i:1767534818;', 1767534818);
...
(3, 1, 9, '2026-01-04 12:49:52', '2026-01-04 12:49:52'),
(4, 1, 16, '2026-01-04 12:49:53', '2026-01-04 12:49:53'),
(5, 1, 1, '2026-01-04 12:49:56', '2026-01-04 12:49:56'),
(6, 1, 14, '2026-01-04 12:49:58', '2026-01-04 12:49:58');
...
(18, '2026_01_05_add_quantity_to_products_table', 11);
...
(3, 3, 10000.00, 'shipping', 'cod', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2025-12-25 23:41:37', '2026-01-04 06:55:26'),
(4, 3, 20000.00, 'cancelled', 'qr', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2025-12-25 23:43:36', '2026-01-04 06:55:19'),
(5, 1, 150000.00, 'completed', 'cod', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2025-12-31 10:06:42', '2025-12-31 10:07:08'),
(6, 2, 420000.00, 'completed', 'qr', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2026-01-04 06:53:23', '2026-01-04 06:55:00'),
(7, 2, 48000.00, 'completed', 'cod', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2026-01-04 06:54:05', '2026-01-04 06:55:08'),
(8, 1, 116000.00, 'pending', 'qr', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2026-01-04 12:31:10', '2026-01-04 12:31:10'),
(9, 1, 40000.00, 'completed', 'cod', '308 Dau Giong Cang Long Vinh Long', '0866085947', NULL, '2026-01-04 12:44:16', '2026-01-04 12:47:07');
...
(6, 6, 14, 1, 400000.00, '2026-01-04 06:53:23', '2026-01-04 06:53:23'),
(7, 6, 4, 1, 8000.00, '2026-01-04 06:53:23', '2026-01-04 06:53:23'),
(8, 6, 1, 1, 12000.00, '2026-01-04 06:53:23', '2026-01-04 06:53:23'),
(9, 7, 16, 1, 32000.00, '2026-01-04 06:54:05', '2026-01-04 06:54:05'),
(10, 7, 18, 1, 16000.00, '2026-01-04 06:54:05', '2026-01-04 06:54:05'),
(11, 8, 17, 1, 84000.00, '2026-01-04 12:31:10', '2026-01-04 12:31:10'),
(12, 8, 16, 1, 32000.00, '2026-01-04 12:31:10', '2026-01-04 12:31:10'),
(13, 9, 11, 1, 40000.00, '2026-01-04 12:44:16', '2026-01-04 12:44:16');
...
CREATE TABLE `products` (
  ...
  `quantity` int(11) NOT NULL DEFAULT 0 COMMENT 'Số lượng trong kho',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('BNvUUvl7SCbA3sAwlBlEqoT79wZepYq2r1NzyLhJ', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1767575346);
...
(1, 'Nguyễn Minh Khởi', 'khoiminh.071204@gmail.com', NULL, '$2y$12$0VItICZOd20THhOq9xYfqep.iVZ/AcuWCwBIQz23JcpaCCSdByEBe', 'q6taL6UjtnhNPk7utAYofackmTzGjY8ey3iNXiw2CFxieWVvwUIIXmZK4dDL', '2025-11-29 08:18:51', '2025-11-29 08:18:51', 1),
